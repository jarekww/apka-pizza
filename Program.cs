...
namespace apka
{
    public class Pizza
    {
        ...
        public class Dodatki : IEquatable<Dodatki>
        {
            public string DodatkiNazwa { get; set; }
            public int DodatkiId { get; set; }
            public override string ToString()
            {
                return "ID :" + DodatkiId + " Name: " + DodatkiNazwa;
            ...
            bool IEquatable<Dodatki>.Equals(Dodatki other)
            {
